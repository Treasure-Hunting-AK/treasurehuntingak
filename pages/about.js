    ...
    <main className={styles.main}>
      <section className={styles.section}>
        ...
        <p>
          ...
          person’s treasure! are passionate about salvaging items, cleaning them
          up, and getting them into the hands of people who see value in them.
          We also love to reuse, recycle, and repurpose.
        </p>
        <p>
